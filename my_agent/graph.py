...
"""
    ...
    llm = ChatOpenAI(name="my-agent", model="gpt-4.1-mini-2025-04-14")
    if tools:
    ...
    builder.add_node("my_agent", assistant)
    ...
    builder.add_edge("tools", "my_agent")
